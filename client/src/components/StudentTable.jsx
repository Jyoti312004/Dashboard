...
export default function StudentTable(props) {
  ...
  const handleSave = () => {
    ...
    const response = axios.patch(`https://mentor-helpdesk.onrender.com/evaluations/${currentStudent._id}`, {
  ...
  const handleConfirm = async (student) => {
    ...
    try{
    const response = await axios.patch(`https://mentor-helpdesk.onrender.com/student/${student._id}/lock`, {
