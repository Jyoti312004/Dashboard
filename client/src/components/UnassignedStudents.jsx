...
const FinalList = () => {
    ...
    const handleSendMail = async () => {
        try {
            const response = await axios.post(`https://mentor-helpdesk.onrender.com/student/sendEmail`, {
    ...
    useEffect(() => {
        ...
        const fetchFinalList = async (mentorId) => {
            try {
                const response = await axios.get(`https://mentor-helpdesk.onrender.com/student/getFinalStudents/${mentorId}`);
