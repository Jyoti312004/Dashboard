...
export const Dropdown = () => {
  ...
  const getStudent = async () => {
    const response = await axios.get('https://mentor-helpdesk.onrender.com/student/getStudent');
    //console.log(response.data);
    setStudents(response.data);
  }

  const getMentor = async () => {
    const response = await axios.get('https://mentor-helpdesk.onrender.com/mentor');
    //console.log(response.data);
  ...
  const handleMentorChange = async (event) => {
    ...
    setSubmitSuccessful(false);
    const res = await axios.get(`https://mentor-helpdesk.onrender.com/mentor/listStudents/${selectedMentorObject._id}`);
  ...
  const handleSubmit = async () => {
    if (OnScreenStudent.length >= 3 && OnScreenStudent.length <= 4) {
      ...
      const response = await axios.patch('https://mentor-helpdesk.onrender.com/student/assign', {
  ...
  const handleRemove = async (id) => {
    ...
    const response = await axios.post('https://mentor-helpdesk.onrender.com/student/removeAssigned', {
      studentId: id,
